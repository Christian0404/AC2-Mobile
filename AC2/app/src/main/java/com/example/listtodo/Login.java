        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(Login.this, "Coloque um e-mail", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(senha)){
                    Toast.makeText(Login.this, "Coloque uma senha", Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    Toast.makeText(getApplicationContext(), "Login funcionando", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(getApplicationContext(), ListaToDo.class);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Toast.makeText(Login.this, "Login incorreto",
